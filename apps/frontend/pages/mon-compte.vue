<template>
  <main class="h-full flex flex-col bg-gray-50 overflow-hidden">
    <div class="flex-1 p-3 max-w-xl mx-auto w-full flex flex-col min-h-0">
      <div
      ...
      >
        ...
        <p class="text-xs">
          Ton adresse et numéro de téléphone sont nécessaires pour faciliter les échanges entre
          parapentistes.
        </p>
        <p class="text-xs mt-2">
          Pour plus d'informations sur le fonctionnement de l'app, consulte la
